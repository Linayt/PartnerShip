...
//     version 1.3.0
//     from Assets/Samples/XR Interaction Toolkit/2.0.0/Starter Assets/XRI Default Input Actions.inputactions
//
...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Fireinput"",
                    ""type"": ""Button"",
                    ""id"": ""b27514fb-21d1-47bc-8066-ce8d306e2ba6"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""93646d86-23ef-409e-a1fb-1b917aa73759"",
                    ""path"": ""<XRController>{RightHand}/triggerPressed"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Noncontinuous Move"",
                ...
                {
                    ""name"": """",
                    ""id"": ""82523130-7539-41ed-9a73-e6b6d9a41a31"",
    ...
    ""controlSchemes"": [
        ...
        m_XRIRightHand_Fireinput = m_XRIRightHand.FindAction("Fireinput", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_XRIRightHand_Fireinput;
    public struct XRIRightHandActions
    {
        ...
        public InputAction @Fireinput => m_Wrapper.m_XRIRightHand_Fireinput;
        ...
        public void SetCallbacks(IXRIRightHandActions instance)
        {
            if (m_Wrapper.m_XRIRightHandActionsCallbackInterface != null)
            {
                ...
                @Fireinput.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnFireinput;
                @Fireinput.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnFireinput;
                @Fireinput.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnFireinput;
            }
